...
long double operator""_cm(long double cm) { return cm * 0.01; }

size_t operator"" _strlen(const char* str, size_t length) { return std::strlen(str); }

class UserDefinedLiterals : public TestBase {
public:
    virtual const char* Name() const override { return "user defined literals"; }
