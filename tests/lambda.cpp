...
You can mark lambda as mutable (otherwise generator operator will be const) or
noexcept Example: [](){} mutable noexcept
...
Global variables or static variable, event which is nearby, will not be
captured. They will be just "accessed".

Even in in text two lambdas are "equal", different closure types will be
generated.
*/
